...
const DeleteProfitDistributionById = ({
  profitDistributionId,
  profitDistributionName,
}: {
  ...
  const [deleteProfitDistribution, { isLoading }] = useDeleteProfitDistributionByIdMutation();

  const handleDelete = async () => {
    if (inputValue !== "DELETE") return;
    const res = await deleteProfitDistribution(profitDistributionId);
    ...
    toast.success("Profit distribution deleted successfully");
    setIsOpen(false);
  };
...
export default DeleteProfitDistributionById;
