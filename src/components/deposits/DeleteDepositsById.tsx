...
const DeleteDepositsById = ({
  ...
  const [deleteDeposit, { isLoading }] = useDeleteDepositByIdMutation();
        ...
        <div className="relative w-full max-w-md transform overflow-hidden rounded-lg bg-white px-6 py-4 shadow-xl transition-all">
          ...
          <div className="">
            ...
            <div className="mt-3 text-center">
              <h3 className="text-lg leading-6 font-medium text-primary">Delete Deposit</h3>
              <div className="mt-2">
...
export default DeleteDepositsById;
